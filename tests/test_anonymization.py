...
class TestHasher(unittest.TestCase):
    ...
    def test_argon2(self) -> None:
        with self.assertRaises(Exception):
            ...
            hasher = DataHasher("Argon2")

        hasher = DataHasher("Argon2", b"example salt")
