...
class TestAggregator(unittest.TestCase):
    ...
    def test_date_aggregator(self):
        ...
        # discard the last 9 chars of the date (timezone info)
        rounded_date = datetime.fromisoformat(rounded_date_str[:-9])
        expected_date = datetime(2023, 4, 27, 16, 23, 0)
        ...
        rounded_date_str = aggregator.apply_on_date("2023-04-27T16:23:45Z")
        rounded_date = datetime.fromisoformat(rounded_date_str[:-9])
        expected_date = datetime(2023, 4, 27, 16, 0, 0)
        self.assertEqual(rounded_date, expected_date)
        ...
        rounded_date_str = aggregator.apply_on_date("2023-04-27T16:23:45Z")
        rounded_date = datetime.fromisoformat(rounded_date_str[:-9])
        expected_date = datetime(2023, 4, 27, 0, 0, 0)
        self.assertEqual(rounded_date, expected_date)
        ...
        rounded_date_str = aggregator.apply_on_date("2023-04-27T16:23:45Z")
        rounded_date = datetime.fromisoformat(rounded_date_str[:-9])
        expected_date = datetime(2023, 4, 1, 0, 0, 0)
        self.assertEqual(rounded_date, expected_date)
        ...
        rounded_date_str = aggregator.apply_on_date("2023-04-27T16:23:45Z")
        rounded_date = datetime.fromisoformat(rounded_date_str[:-9])
        expected_date = datetime(2023, 1, 1, 0, 0, 0)
        self.assertEqual(rounded_date, expected_date)
